...
execute as @a if predicate voidborn:holding/holding_void_shard store result score @s void.void_shard_damage run data get entity @s SelectedItem.tag.voidborn.durability
